...
SMTP_PORT = 587
EMAIL_SENDER = os.environ.get('EMAIL_SENDER', 'YOUR_SENDER_EMAIL@gmail.com') # Takes from .env or default
EMAIL_PASSWORD = os.environ.get('EMAIL_PASSWORD', 'YOUR_APP_PASSWORD') # Takes from .env or default
EMAIL_RECEIVER = 'recipient_email@example.com' # !!! CHANGE THIS TO YOUR EMAIL !!!
